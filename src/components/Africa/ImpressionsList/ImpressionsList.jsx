...
const review1 = 'First Class - это просто находка для туриста, которого уже сложно удивить. Компания организует такие туры, которые невозможно даже себе представить. Эти впечатления останутся навсегда.';
...
const review3 = 'Отдых в Африке оказался для нас настоящим открытием! Мы побывали в таинственных племенных поселениях, попробовали местную кухню и окунулись в мир традиций и обычаев этого загадочного континента.';
