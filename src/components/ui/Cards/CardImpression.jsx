  ...
  const [titles] = useState([
    {
      ...
      text: ['с восхождением на Эльбрус', 'и морозное утро в горах', 'по вечному леднику', 'выше облаков'],
      img: [img1, img2, img3, img4]
    },
    {
      title: 'Шикарные',
      text: ['отели в Сингапуре', 'огни мегаполисов', 'виды современного мира', 'номера и высочайшее обслуживание'],
      img: [img5, img6, img7, img8]
    },
    {
      title: 'Тибетский рай',
      text: ['на базе Кайласа', 'в долине Гималаев', 'на берегу озера Намсо', 'в затерянных джунглях'],
